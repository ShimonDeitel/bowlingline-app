...
struct ContentView: View {
    ...
    @State private var editingEntry: OutingEntry?
    ...
    private func row(for entry: OutingEntry) -> some View {
        HStack {
...
struct EntryEditView: View {
    ...
    let existingId: UUID?
    let onSave: (OutingEntry) -> Void

    init(entry: OutingEntry?, onSave: @escaping (OutingEntry) -> Void) {
    ...
    var body: some View {
        NavigationStack {
            Form {
                Section("Outing details") {
                    TextField("Title", text: $title)
                        .accessibilityIdentifier("titleField")
                    TextField("Alley", text: $vendor)
            ...
            .navigationTitle(existingId == nil ? "Add Outing" : "Edit Outing")
            .toolbar {
                ...
                ToolbarItem(placement: .confirmationAction) {
                    Button("Save") {
                        ...
                        let entry = OutingEntry(
                            id: existingId ?? UUID(),
                            title: title.isEmpty ? "Outing" : title,
                            vendor: vendor,
                            amount: amount,
                            date: date,
                            notes: notes
